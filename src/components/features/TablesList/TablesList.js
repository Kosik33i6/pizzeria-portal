...
const tables = [
  ...
  },
  {
    ...
    orders: [
      ...
      {id: 2, tableId: 3, name: 'order-2', status: 'active'},
  ...
  },
  {
    ...
    maxNumberOfPeople: 5,
    orders: [
      {id: 1, tableId: 4, name: 'order-1', status: 'active'},
      {id: 2, tableId: 4, name: 'order-2', status: 'active'},
      {id: 3, tableId: 4, name: 'order-3', status: 'active'},
